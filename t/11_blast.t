...
##   $run_blast->{output} => outputs/11phix/split_search.txt.xz
##   $run_blast->{parser}->{count_output} outputs/11phix/split_search.txt.xz
##   $run_blast->{parser}->{parsed_output} outputs/11phix/split_search_parsed.txt
##   $run_blast->{parser}->{input} outputs/11phix/blastn.out
...
ok(-r $blast_txt, "The blast raw output was created: ${blast_txt}.");
